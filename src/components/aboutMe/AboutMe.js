...
const AboutMe = () => {
  ...
  return (<div>
    ...
    <div className='text'>
      ...
      <h3>Before the metamorphosis of the internet, I was an editorial art director/designer for major publishing houses here in nyc. As the internet evolved, the plethora of magazines diminished and the usage of the revolving door increased. I broadened my skillset and became adept in designing for the iPad, iPhone.
      </h3>
      <h1>(and around).
      </h1>
    ...
    <a  href="http://www.cynthiaeddy.com">
      <h5>| my print and digital portfolio </h5>
    </a>
